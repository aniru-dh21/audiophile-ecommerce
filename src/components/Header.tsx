...
export default function Header() {
  ...
  return (
    <header
      className={`fixed z-20 w-full top-0 left-0 flex flex-col ${
        isNavVisible ? "h-screen" : ""
      } ${pathname === "/" ? "bg-[#181818]" : "md:bg-black"}`}
    >
      <div
        className={`container mx-auto flex justify-between items-center px-6 py-8 border-gray-800 ${
          pathname === "/" ? "bg-[#181818]" : "bg-black"
        }`}
      >
        <div
        ...
        >
          ...
          ></Image>
          <div
            className={`w-2 h-2 bg-orange-color rounded-full absolute -right-1 top-0 ${
