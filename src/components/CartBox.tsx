          ...
          <div className="mt-8 max-h-[40vh] overflow-y-auto cart-list-container">
            <ul className="grid gap-8">
              {cartData.map((item, index) => {
                return <CartElement key={index} itemData={item} />;
              })}
            </ul>
          </div>
          <div className="mt-8">
            <div className="flex justify-between">
              <div className="uppercase text-secondary-color">total</div>
            ...
            <div className="mt-6">
              <Link
                ...
                } text-center block text-xs py-3 px-8 bg-button-orange-color text-white uppercase tracking-wider cursor-pointer hover:bg-button-orange-hover-color`}
              >
                checkout
              </Link>
            </div>
