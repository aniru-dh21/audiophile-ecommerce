  ...
  switch (type) {
    case "orange":
      return (
        <Link
          href={href}
          className="block text-center text-xs py-3 px-8 bg-button-orange-color text-white uppercase tracking-wider cursor-pointer hover:bg-button-orange-hover-color"
        >
          {title}
        </Link>
      );
